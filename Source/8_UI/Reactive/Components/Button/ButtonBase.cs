...
namespace BeatLeader.UI.Reactive.Components {
    internal abstract class ButtonBase : DrivingReactiveComponentBase, IAnimationProgressProvider, IGraphicComponent, IClickableComponent, IInteractableComponent {
        #region Events
