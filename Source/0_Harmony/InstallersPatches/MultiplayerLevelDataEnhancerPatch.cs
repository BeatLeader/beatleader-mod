...
namespace BeatLeader {
    ...
    {
        static void Postfix(MultiplayerLevelScenesTransitionSetupDataSO __instance, string gameMode, in BeatmapKey beatmapKey, BeatmapLevel beatmapLevel, IBeatmapLevelData beatmapLevelData, ColorScheme overrideColorScheme, PlayerSpecificSettings playerSpecificSettings, PracticeSettings practiceSettings, AudioClipAsyncLoader audioClipAsyncLoader, BeatmapDataLoader beatmapDataLoader, bool useTestNoteCutSoundEffects = false)
        {
